...
namespace ExplosionTypes
{
    public class DeathActionWorker_SmallBomb : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse)
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, DamageDefOf.Bomb, corpse.InnerPawn, -1,null, null, null, ThingDef.Named("FilthBlood"), .7f, 1, false, null, 0f, 1);
        }
