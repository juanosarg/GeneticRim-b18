...
namespace ExplosionTypes
{
    public class DeathActionWorker_PsionicExplosion : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse)
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, Named("GR_PsionicExplosion"), corpse.InnerPawn, -1,SoundDef.Named("Explosion_Bomb"), null, null, ThingDef.Named("Poison_Gas"), 1f, 1, false, null, 0f, 1);
        }
